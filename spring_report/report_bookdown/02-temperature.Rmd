...
knitr::include_graphics(file.path("..","temp_splspring.png"))
```
...
knitr::include_graphics(file.path("..","temp_ssspring.png"))
```
...
knitr::include_graphics(file.path("..","temp_dtspring.png"))
```
