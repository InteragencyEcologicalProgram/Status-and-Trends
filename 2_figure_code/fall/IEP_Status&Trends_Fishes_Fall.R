...
fmwt<-read.csv(file.path(data_root,"fmwt.csv"))
str(fmwt)
...
#Traditional Index starting in 1967
...
theme(legend.position="none") + 
  ...
  missing_data_symb(ds, fyear, report_year, 2)+
  lt_avg_line(mean(ds$Index, na.rm = T))
p_ds
ggsave(p_ds, file="FMWT_DS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_ds, file="FMWT_DS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
...
p_lfs <- ggplot(lfs, aes(x=fyear, y=Index))+
  ...
  std_x_axis_all_years(report_year) +
  missing_data_symb(lfs, fyear, report_year, 2)+
  lt_avg_line(mean(lfs$Index, na.rm = T))
p_lfs  
  
ggsave(p_lfs, file="FMWT_LFS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_lfs, file="FMWT_LFS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
p_sb0 <- ggplot(sb0, aes(x=fyear, y=Index))+
  ...
  std_x_axis_all_years(report_year) +
  missing_data_symb(sb0, fyear, report_year, 2)+
  std_x_axis_label("fall")+
  lt_avg_line(mean(sb0$Index, na.rm = T))
ggsave(p_sb0, file="FMWT_SB0_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_sb0, file="FMWT_SB0_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
# ggsave(p_sb0, file="FMWT_SB0_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
...
(p_as <- ggplot(as, aes(x=fyear, y=Index))+
   ...
   theme(legend.position="none") + 
    ...
    std_x_axis_all_years(report_year) +
    std_x_axis_label("fall")+
    missing_data_symb(as, fyear, report_year, 2)+
  lt_avg_line(mean(as$Index, na.rm = T)))
ggsave(p_as, file="FMWT_AS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_as, file="FMWT_AS_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
p_wst <- ggplot(wst, aes(x=fyear, y=AvgCPUE))+
  ...
  std_x_axis_all_years(report_year) +
  missing_data_symb(wst, fyear, report_year, 2)+
  lt_avg_line(mean(wst$AvgCPUE, na.rm = T))
ggsave(p_wst, file="WST_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_wst, file="WST_1966.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
p_ds <- ggplot(ds, aes(x=fyear, y=Index))+
  ...
  lt_avg_line(mean(ds$Index, na.rm = T))
p_ds
ggsave(p_ds, file="FMWT_DS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_ds, file="FMWT_DS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
ggsave(p_lfs, file="FMWT_LFS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_lfs, file="FMWT_LFS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
(p_sb0 <- ggplot(sb0, aes(x=fyear, y=Index))+
    ...
    missing_data_symb(sb0, fyear, report_year, 2))+
  lt_avg_line(mean(sb0$Index, na.rm = T))
ggsave(p_sb0, file="FMWT_SB0_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_sb0, file="FMWT_SB0_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
(p_as <- ggplot(as, aes(x=fyear, y=Index))+
    ...
    missing_data_symb(as, fyear, report_year, 2)+
    lt_avg_line(mean(as$Index, na.rm = T)))
ggsave(p_as, file="FMWT_AS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_as, file="FMWT_AS_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
...
(p_wst <- ggplot(wst, aes(x=fyear, y=AvgCPUE))+
  ...
  missing_data_symb(wst, fyear, report_year, 2)+
  lt_avg_line(mean(wst$AvgCPUE, na.rm = T))
ggsave(p_wst, file="WST_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
       path = fig_root_fall)
# ggsave(p_wst, file="WST_2004.png", dpi=300, units="cm", width=9.3, height=6.8, 
#        path = "report_bookdown/figures")
