...
redtest = Red + geom_bar(stat = "identity") + ylab("Estimated dialy passage") + xlab("Year (December-January)") +
...
ggsave(redtest, file="redtest.png", dpi=300, units="cm", width=9.3, height=6.8)
