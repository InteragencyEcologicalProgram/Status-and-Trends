...
destfile <- file.path(data_root,"Lab_Data_1985_1995x.xlsx")
...
destfile <-  file.path(data_root,"Lab_Data_1975_1984x.xlsx")
curl_download(url, destfile)
...
destfile <-  file.path(data_root,"Lab_Data_1996_1912x.xlsx")
curl_download(url, destfile)
...
destfile <-  file.path(data_root,"Field_Data_1975_1987x.xlsx")
curl_download(url, destfile)
...
destfile <- file.path(data_root,"Field_Data_1988_2006x.xlsx")
curl_download(url, destfile)
...
destfile <- file.path(data_root,"Field_Data_2000_2018x.csv")
curl_download(url, destfile)
...
Field_Data_2000_2018x <- read_csv(destfile, 
...
#save the result
write.csv(WQ_all, file.path(data_root,"WQ_Discrete_1975-2018.csv"), row.names = F)
