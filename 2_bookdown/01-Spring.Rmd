...
* Juvenile Winter-Run Chinook salmon out-migrate to the ocean in spring, and are sampled by the USFWS’s [Chipps Island Trawl](https://iep.ca.gov/Science-Synthesis-Service/Monitoring-Programs/Delta-Juvenile-Fish), located at the confluence of the Sacramento and San Joaquin Rivers. 
...
```{block, type='disclaimer'}
For more information see: Kwan, N., H. Hudson, A. Casby, and B. Schreier. 2021. [2018-2019 Yolo Bypass Fisheries Monitoring Status and Trends Report](https://cadwr.app.box.com/s/08zksus58rekl4tfy12mpxqqpz5bvhp9). IEP Newsletter 40(2):35-45. 
```
...
* Delta Smelt and Longfin Smelt have been in decline since the early 2000s. The [CDFW 20mm Survey](https://iep.ca.gov/Science-Synthesis-Service/Monitoring-Programs/20-mm) was designed to sample post-larval and juvenile Delta Smelt, and samples in San Pablo, Suisun, and the Delta. 
