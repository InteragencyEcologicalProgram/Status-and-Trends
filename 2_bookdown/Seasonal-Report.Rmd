...
knitr::include_graphics(file.path(fig_root_spring,"DJFMP_chinook_winterByLength_allyears.png"))
```
:::
::::
...
knitr::include_graphics(file.path(fig_root_spring,"DJFMP_chinook_winterByLength_recyears.png"))
```
:::
::::
